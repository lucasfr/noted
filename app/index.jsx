...
// Update html/body background colour for status bar and bottom safe area
if (Platform.OS === 'web' && typeof document !== 'undefined') {
  window.__notedUpdateHtmlBg = (dark) => {
    const bg = dark ? '#1A2330' : '#E8EDF2';
...
export default function Shell() {
  ...
  // Keep html/body background in sync with theme for status bar and bottom strip
  React.useEffect(() => {
    if (Platform.OS === 'web' && window.__notedUpdateHtmlBg) {
      window.__notedUpdateHtmlBg(theme === 'dark');
    }
  }, [theme]); // fires on mount AND on every theme change
