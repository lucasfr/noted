...
function expandIsland()   { island.classList.remove('collapsed'); textarea.focus(); }
function collapseIsland() { if (textarea.value.trim()) return; textarea.blur(); island.classList.add('collapsed'); }
